...
class EditBoardScreen extends StatefulWidget {
  final board;
  @override
  EditBoardScreen({Key key, @required this.board}) : super(key: key);

  @override
  EditBoardState createState() => EditBoardState();

}

class EditBoardState extends State<EditBoardScreen> with SingleTickerProviderStateMixin {
